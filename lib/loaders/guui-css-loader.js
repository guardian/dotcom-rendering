...
// e.g. a.b.c => --a-b-c
const toVars = (vars: Object, prefix: string = ''): Object =>
...
const normaliseCSS = (source: string): string =>
    postcss()
        .use(
            customProperties({
                ...
                extensions: Object.keys(pasteup.breakpoints).reduce(
                    (breakpoints, breakpoint) =>
                        Object.assign({}, breakpoints, {
                            [`--from-${breakpoint}`]: `(min-width: ${pasteup.breakpoints[
                                breakpoint
                            ] / 16}em)`,
                            [`--until-${breakpoint}`]: `(max-width: ${(pasteup.breakpoints[
                                breakpoint
                            ] -
                                1) /
                                16}em)`,
