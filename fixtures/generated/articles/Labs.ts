	...
	mainMediaElements: [
		{
			...
			elementId: '06a55381-85af-4200-860a-13f3cb79dd69',
		},
	],
			...
			elements: [
				{
					...
					elementId: 'e56d29a5-24c2-4f77-bdf6-b9404148a877',
				},
				{
					html:
					...
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					elementId: '56bbdc44-e99c-493b-bf6b-42a843b8dd1e',
				},
				{
					html:
					...
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					elementId: '36279123-93c1-41ac-b77e-a2039e353af0',
				},
				{
					media: {
						allImages: [
					...
					elementId: '3596dfc5-5de9-47ba-aeea-c338660fe719',
				},
				{
					html:
					...
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					elementId: '1ce8262b-d2db-49ce-b8ae-aac5e7e6e4ae',
				},
				{
					html:
					...
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					elementId: '1b8517d4-bb07-4f92-bb6d-59fe21825765',
				},
				{
					html:
					...
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					elementId: 'c7f16e72-19e9-4773-b5fb-2288307f63d6',
				},
				{
					html:
					...
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					elementId: '0b0d57a4-0ef4-4a25-b13e-4a8c75d4e582',
				},
				{
					html:
					...
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					elementId: '40992f2b-29c6-455b-afba-92a2e62c6827',
				},
				{
					html:
					...
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					elementId: '86d640bd-70fa-4487-8de6-8ad266074dfc',
				},
				{
					media: {
						allImages: [
					...
					_type:
						'model.dotcomrendering.pageElements.ImageBlockElement',
					elementId: 'a2ca4166-9af2-4ec9-9175-02773aedd76d',
				},
				{
					html:
					...
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					elementId: '79951ba4-8a7f-4245-9115-09fa3a8784a1',
				},
				{
					html:
					...
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					elementId: 'a33d1dcd-e00d-4807-bad4-8b513af611fc',
				},
				{
					html:
					...
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					elementId: 'a0611ec5-70f7-47ca-8588-88e5148d7b56',
				},
				{
					html:
					...
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					elementId: 'de6ff67b-ab33-44af-8703-381209d1a2ea',
				},
				{
					html:
					...
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					elementId: 'd3464738-c44a-4d34-8ee9-602c3ab5cf5f',
				},
			],
