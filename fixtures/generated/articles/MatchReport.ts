...
export const MatchReport: CAPIType = {
	...
	mainMediaElements: [
		{
			elementId: 'e763a537-92e6-4e4c-9251-687b299b8959',
			role: 'inline',
			data: {
				alt:
	...
	blocks: [
		{
			...
			elements: [
				{
					elementId: '269599d6-8586-42b8-94d1-69f014eea1bf',
					_type:
				...
				{
					elementId: 'e50f81e5-2716-426f-962e-ea6f663d9b36',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: 'b8bbd955-53d4-4fd0-a1e4-8ffaddce45b0',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '5c765117-f660-45bf-8148-8b4380b23432',
					role: 'thumbnail',
					prefix: 'Related: ',
					_type:
				...
				{
					elementId: 'b88cc30f-8029-4a53-9980-c61e021970b2',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '9ab4fdda-1bfe-4a09-94a3-0c5366fa5397',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: 'e64cd70c-814f-43f0-a426-d567e72b212a',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '55bfedb0-02e9-4346-bd48-7f52fb66e326',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '2f372338-bc75-4d32-a51b-ee9934e0753b',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '48bb3a8c-4507-4ec0-9386-5d30db95ebb8',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: 'eb51f4e6-1882-429c-8668-ccc24249a90c',
				...
				{
					elementId: '118a5e84-0cae-4ae9-ac05-201663dfeb6e',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '26e7e08b-249b-4896-8023-173003846c82',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
