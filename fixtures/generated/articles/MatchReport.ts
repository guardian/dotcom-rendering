...
export const MatchReport: CAPIType = {
	...
	mainMediaElements: [
		{
			elementId: '3a962903-828c-4c9b-ae78-329437f4bf95',
			role: 'inline',
			data: {
				alt:
	...
	blocks: [
		{
			...
			elements: [
				{
					elementId: '7354048d-b9d4-4702-8d03-1505eefc1c63',
					_type:
				...
				{
					elementId: '78176479-6825-4eb2-a999-660cd291c647',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: 'a504cf6b-f2ec-40ce-8bf9-5b095b1cac73',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: 'eb5d84f2-aab3-4a6b-85b6-8a9360f39dbe',
					role: 'thumbnail',
					prefix: 'Related: ',
					_type:
				...
				{
					elementId: '767bd94e-e334-4eed-9ed1-01ddb9105aa5',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '909f6741-5b08-414c-8034-5659de6bbeeb',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '360848a9-c4de-4625-94c8-11aa8026c536',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '44693597-58e4-4b23-9388-efd388e1c3b0',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '1e616737-c5e0-49af-9710-67115e9f746a',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '687630ea-aaab-4d84-88a7-7e159233b805',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '7fc3a2ad-d3bd-41e1-ae7a-68b55fdf6998',
				...
				{
					elementId: '665d26da-4669-4409-b1a2-5ed4887ffe65',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '3a1869f6-7be4-4567-bccc-ca32e12d8216',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
	...
	config: {
		...
		references: [
			{
				'opta-football-team': '45',
			},
			{
				'esa-football-team': '/" + "football/" + "team/" + "15',
			},
			{
				'opta-football-team': '80',
			},
			{
				'opta-football-tournament': '10/2012',
			},
			{
				'esa-football-tournament':
					'/" + "football/" + "tournament/" + "div1',
			},
			{
				'pa-football-competition': '101',
			},
			{
				'esa-football-team': '/" + "football/" + "team/" + "58',
			},
			{
				'pa-football-team': '65',
			},
		...
		keywordIds:
			'football/championship,football/swansea,football/norwichcity,football/football,sport/sport',
		blogIds: '',
		sharedAdTargeting: {
			ct: 'article',
			co: ['ben-fisher'],
			...
			tn: ['matchreports'],
			p: 'ng',
			k: ['norwichcity', 'swansea', 'championship', 'sport', 'football'],
			sh: 'https://www.theguardian.com/p/gba7d',
		},
		beaconUrl: '//phar.gu-web.net',
		campaigns: [],
		calloutsUrl:
		...
		trackingNames: 'UK Sport',
		fbAppId: '180444840287',
		externalEmbedHost: 'https://embed.theguardian.com',
		ajaxUrl: 'https://api.nextgen.guardianapps.co.uk',
		keywords: 'Championship,Swansea City,Norwich City,Football,Sport',
		revisionNumber: 'DEV',
		blogs: '',
		section: 'football',
		...
		thumbnail:
			'https://i.guim.co.uk/img/media/cc1d3dc14ab9104587323ef12ac477004b369637/67_36_1713_1028/500.jpg?quality=85&auto=format&fit=max&s=ce6e5b717189e5797daebe43013fef65',
		isFront: false,
		wordCount: 695,
		author: 'Ben Fisher',
		dfpAccountId: '59666047',
		nonKeywordTagIds:
			'type/article,tone/matchreports,profile/ben-fisher,publication/theguardian,theguardian/sport,theguardian/sport/news,tracking/commissioningdesk/uk-sport',
		pageId:
			'football/2021/feb/05/andre-ayew-sparks-swansea-victory-over-norwich-to-close-gap-at-top',
			...
			images: [
				{
					...
					src:
						'https://i.guim.co.uk/img/media/cc1d3dc14ab9104587323ef12ac477004b369637/67_36_1713_1028/master/1713.jpg?width=700&quality=85&auto=format&fit=max&s=c26150091859708116bb6f3b1d8e6fd7',
					srcsets:
						'https://i.guim.co.uk/img/media/cc1d3dc14ab9104587323ef12ac477004b369637/67_36_1713_1028/master/1713.jpg?width=1920&quality=85&auto=format&fit=max&s=e34fb78dcec4449f481b01b37d89cf76 1920w, https://i.guim.co.uk/img/media/cc1d3dc14ab9104587323ef12ac477004b369637/67_36_1713_1028/master/1713.jpg?width=1225&quality=85&auto=format&fit=max&s=b0d2f1bd1a855851e728d64bc315b549 1225w, https://i.guim.co.uk/img/media/cc1d3dc14ab9104587323ef12ac477004b369637/67_36_1713_1028/master/1713.jpg?width=1065&quality=85&auto=format&fit=max&s=5bc32ba4e664d1befb3baa2982822d59 1065w, https://i.guim.co.uk/img/media/cc1d3dc14ab9104587323ef12ac477004b369637/67_36_1713_1028/master/1713.jpg?width=965&quality=85&auto=format&fit=max&s=ef553179832fe351026879cd5cca4017 965w, https://i.guim.co.uk/img/media/cc1d3dc14ab9104587323ef12ac477004b369637/67_36_1713_1028/master/1713.jpg?width=725&quality=85&auto=format&fit=max&s=474e255381529f0047dff2dd11389d1b 725w, https://i.guim.co.uk/img/media/cc1d3dc14ab9104587323ef12ac477004b369637/67_36_1713_1028/master/1713.jpg?width=645&quality=85&auto=format&fit=max&s=3137a1577d4433cdf7b6e95fd8d4cf78 645w, https://i.guim.co.uk/img/media/cc1d3dc14ab9104587323ef12ac477004b369637/67_36_1713_1028/master/1713.jpg?width=465&quality=85&auto=format&fit=max&s=271e6711f51b1c0055793baf2749bd32 465w',
					sizes:
		...
		abTests: {},
		shortUrl: 'https://www.theguardian.com/p/gba7d',
		isContent: true,
		contentId:
			'football/2021/feb/05/andre-ayew-sparks-swansea-victory-over-norwich-to-close-gap-at-top',
		edition: 'UK',
		...
		byline: 'Ben Fisher at the Liberty Stadium',
		authorIds: 'profile/ben-fisher',
		webPublicationDate: 1612563403000,
