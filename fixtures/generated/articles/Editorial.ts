...
export const Editorial: CAPIType = {
	...
	mainMediaElements: [
		{
			elementId: '4c52118f-2ced-4986-9921-92627c6551dd',
			role: 'inline',
			data: {
				alt:
	...
	blocks: [
		{
			...
			elements: [
				{
					elementId: '6f218643-c073-4029-9e98-10d7642a6a22',
					_type:
				...
				{
					elementId: '0878dbb2-b81e-4dd3-a5f6-72f4729b4c15',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '0fa30c66-1495-4b9e-b262-2d926ffb6a9f',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '012659aa-b111-4dd4-9143-a8de07595997',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '29ef5f4d-9a98-4786-9818-db10888afa7a',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '0242c114-5a62-4a6e-90ec-884a0765b415',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
