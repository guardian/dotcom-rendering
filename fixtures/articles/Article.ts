...
export const Article: CAPIType = {
	...
	mainMediaElements: [
		{
			elementId: 'b36518fb-f266-40ad-8878-6d9c8fda9f04',
			role: 'inline',
			data: {
	...
	blocks: [
		{
			...
			elements: [
				{
					elementId: '0c352617-1902-4bc2-9715-8048d467dafc',
					_type:
				...
				{
					elementId: 'bac80143-80ef-4ffc-9481-e978d460af52',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: 'df79f891-d4b4-46d4-a59c-73ae25ba8db7',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: 'b150edcb-6a6c-4fe5-a853-707986c806f7',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: 'fd1ad5c2-4f1a-4597-8bf0-15443bf24fbe',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '832df6da-d7db-4e1d-999d-2d875e1ac50e',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: 'ff238ce5-2d30-4dc5-88ed-b1f417b76a5a',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '66525321-3636-4096-8211-22bd44b1e5cb',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '34378531-200e-4c16-b0af-2475aa59b782',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '004e2f86-c165-429c-bd8f-141bf1f1a638',
					role: 'inline',
					data: {
				...
				{
					elementId: '3406e7b1-8350-4e3e-97a4-7ad74dc8c9e4',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: 'ebee345b-550c-4f4b-9bbe-969f9d362009',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: 'f6297504-10d5-48d4-bd3b-01bac1a7ab59',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: 'aeb5265a-e60f-4681-b050-ed855fb94c60',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '25ab9337-12ff-4a98-9261-e1ea24717b04',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '9b6b2a92-c3b5-44ab-8e1b-1854a529a2dd',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '9adfba91-f2e0-453e-aaf0-95ccd4d6ecc4',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '60a61ef8-3b89-4fd1-b073-2144ade72e15',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
				...
				{
					elementId: '12f39dce-4b95-4ee7-8f3f-27b49c0ee77a',
					_type:
						'model.dotcomrendering.pageElements.TextBlockElement',
					html:
