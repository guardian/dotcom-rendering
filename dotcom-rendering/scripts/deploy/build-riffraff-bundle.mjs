...
// ├── rendering-fronts
// │   ├── DotcomRendering-CODE-fronts.template.json
// ├── frontend-static
// │   ├── assets
// │   │   └── **
// │   │       └── *
...
const copyRenderingfrontsCfn = () => {
	log(' - copying cloudformation config');
	return cpy(
		[
			'cdk.out/DotcomRendering-fronts-CODE.template.json',
		],
		path.resolve(target, 'rendering-fronts'),
	);
};
