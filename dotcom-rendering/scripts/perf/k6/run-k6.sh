...
echo "Running Article AJV vs Zod Mini tests...."
...
echo "------------------------------------" >> k6-output.txt
./k6-bin run k6-article-zod-mini.mjs
./k6-bin run k6-article-zod-mini.mjs >> k6-output.txt
...
echo "------------------------------------" >> k6-output.txt
./k6-bin run k6-front-zod-mini.mjs
./k6-bin run k6-front-zod-mini.mjs >> k6-output.txt
