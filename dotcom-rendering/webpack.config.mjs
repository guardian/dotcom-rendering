...
await mkdir(resolve(dirname, 'configs', 'webpack'), { recursive: true });
await writeFile(
	resolve(dirname, 'configs', 'webpack', 'manifest.bundles.mjs'),
...
export default [...clientConfigs, 'server.mjs'].map((name) =>
