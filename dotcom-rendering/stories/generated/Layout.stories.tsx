...
WebStandardStandardNewsPillar.decorators = [splitTheme([
		{
...
AppsStandardStandardNewsPillar.decorators = [splitTheme([
		{
			display:  ArticleDisplay.Standard,
			design: ArticleDesign.Standard,
			theme: {...ArticleSpecial, ...Pillar}.News,
...
AppsShowcaseStandardNewsPillar.decorators = [splitTheme([
		{
...
WebShowcasePictureOpinionPillar.decorators = [splitTheme([
		{
			display:  ArticleDisplay.Showcase,
...
AppsShowcasePictureOpinionPillar.decorators = [splitTheme([
		{
			display:  ArticleDisplay.Showcase,
			design: ArticleDesign.Picture,
			theme: {...ArticleSpecial, ...Pillar}.Opinion,
...
AppsStandardCommentNewsPillar.decorators = [splitTheme([
		{
			display:  ArticleDisplay.Standard,
...
AppsStandardInteractiveNewsPillar.decorators = [splitTheme([
		{
			display:  ArticleDisplay.Standard,
...
AppsImmersiveStandardNewsPillar.decorators = [splitTheme([
		{
