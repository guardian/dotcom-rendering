	...
	mainMediaElements: [
		{
			...
			elementId: '3d107496-2b4d-4216-b990-6762fa83b15a',
			imageSources: [
				{
					weighting: 'inline',
					srcSet: [
			...
			elements: [
				{
					...
					elementId: 'fe27beca-fe80-4417-9491-fb4403e75891',
				},
				{
					...
					elementId: '863df8f1-a5a9-47ae-9f0c-46e34ac6d5bf',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '3f09608d-5fe5-495e-99f4-695620f33fed',
				},
				{
					_type: 'model.dotcomrendering.pageElements.RichLinkBlockElement',
					prefix: 'Related: ',
					text: 'Ireland election: latest results',
					elementId: '64bdd653-3330-4475-8caf-de38e4d0911c',
					role: 'thumbnail',
				...
				},
				{
					...
					elementId: '56421e99-009e-4745-9a21-c302a6f0dd85',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2>Was Sinn Féin’s success a surprise?</h2>',
					elementId: '462afaf2-0cd1-4fde-bb18-a0027aef7b69',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '969384bd-e4ed-49be-b053-fe4da6836c2c',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2>Is Varadkar going to lose power?</h2>',
					elementId: 'a964b0db-6190-438c-84dd-6b25095b2f34',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
				...
				},
				{
					...
					elementId: '7893fddb-19e6-4a09-9f79-d489b8903a32',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '62183bdc-1d80-405b-9263-b850a65fdeb3',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '5ee5b501-6fd0-4ff3-bbe2-2666e2b55fbf',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2>What happens next?</h2>',
					elementId: '504de3d3-86be-4d0c-9cbd-541fbed15bea',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '8ba6ec03-92ee-466e-bad9-df4f3b113f00',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'e45e7a23-04c7-4de6-b40f-aae684bf1a41',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'cdcfd92b-6a6a-432d-af4b-adb73c93881d',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'b30c0420-5330-4aa2-a25c-0f52fd2d81d9',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					html: '<p>One plausible outcome: deadlock, and another election.</p>',
					elementId: '8a05f81f-7fac-4528-946e-f966c1d9b2c8',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					html: '<p><strong>Read more</strong></p>',
					elementId: '737cdcad-318c-4ca9-8456-cf0e717f0559',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '70d6fcd3-daad-48c1-af24-e8f871e3ef2b',
				},
			],
			attributes: {
				pinned: false,
