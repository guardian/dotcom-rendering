	...
	mainMediaElements: [
		{
			...
			elementId: '34d8631b-af9b-4691-b4b0-e917055f107d',
			imageSources: [
				{
					weighting: 'inline',
					srcSet: [
			...
			elements: [
				{
					...
					elementId: 'db6dfd9e-3986-4cbe-9c62-a90a90afd357',
				},
				{
					...
					elementId: '6343843d-143f-4e20-9fea-5e43215bc309',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'de4cc06e-6067-4882-8420-58d98e89a83a',
				},
				{
					_type: 'model.dotcomrendering.pageElements.RichLinkBlockElement',
					prefix: 'Related: ',
					text: 'Ireland election: latest results',
					elementId: '8a5b0be8-4d97-4204-bc01-9ae6d576b461',
					role: 'thumbnail',
				...
				},
				{
					...
					elementId: '72e524f9-fd70-4a9b-8009-36b4dc4d4823',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2>Was Sinn Féin’s success a surprise?</h2>',
					elementId: 'a12f6518-1202-49f3-8300-686c092965b8',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '27cde3ff-1085-4912-924c-b13bfe29caf0',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2>Is Varadkar going to lose power?</h2>',
					elementId: '1cd39dcc-f586-4a40-9a43-8e5223b81a27',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
				...
				},
				{
					...
					elementId: '7da0fc1f-934b-45f2-9dbb-ef050150f013',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '61977808-ec5d-4288-a1b9-a50fb22079b2',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '0d0d27f6-7dfc-4cd3-9554-754cae697eb1',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2>What happens next?</h2>',
					elementId: '44c9de3e-a725-49eb-8f29-d4ce21489dac',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'e4b087ec-129b-4211-9d43-ae284243ad27',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'f2f2d632-c0a2-44ae-ae6c-ac0aea1d999b',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '95c25cec-c2b4-4e90-9547-6a3eb0bdb5c9',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '72906226-6d3b-4903-ab3c-c623b1e8d5f1',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					html: '<p>One plausible outcome: deadlock, and another election.</p>',
					elementId: 'f5c1264b-dab2-4b2b-8b75-ffd97ddf5a0d',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					html: '<p><strong>Read more</strong></p>',
					elementId: '1aa0e87f-31eb-4f81-a58a-214145d42bf8',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'b2a3bfc8-c844-404d-8c5c-eab49b960510',
				},
			],
			attributes: {
				pinned: false,
