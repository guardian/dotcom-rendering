...
export const Recipe: FEArticle = {
	...
	mainMediaElements: [
		{
			...
			elementId: 'aabec3aa-ad01-41ce-8248-d963be93d2dd',
			imageSources: [
				{
					weighting: 'inline',
					srcSet: [
	...
	blocks: [
		{
			...
			elements: [
				{
					...
					elementId: '68d25eec-29fb-4ed5-bc8e-dd8a401166c8',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2>Spring onion pancakes with sesame sauce</h2>',
					elementId: 'b3fef270-e4b9-416a-806c-5ceadc148b13',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '7b34da62-3d8b-4dc4-a634-f0928138c70b',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '2232a36f-95c6-42ec-b45d-e572cf8a480d',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '4636ab50-647c-41ec-9858-19ddca4219f5',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'b878a532-07a9-4eff-b1af-d4b1c62a1dd2',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '8c0762db-835c-464c-8924-74920a3efb58',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'ecd37e02-b5ef-4021-ab70-0558f7d0d8c3',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'bff852e4-7179-4dc6-8b28-9d91bae85e80',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '57a60a74-9316-40ec-be24-5509de51c9a6',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '5ee58d82-6a25-4994-9dbd-c8b93f0ae794',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					html: '<p>Serve the pancakes hot with the sauce for dipping or drizzling over the top.</p>',
					elementId: 'f3d96ff1-b3d1-42be-b438-0ff473e97513',
				},
			],
			attributes: {
				pinned: false,
			...
			secondaryDateLine: 'Last modified on Tue 2 Dec 2025 08.27 GMT',
		},
	],
	author: {
		byline: 'Meera Sodha',
	...
	webPublicationSecondaryDateDisplay:
		'Last modified on Tue 2 Dec 2025 08.27 GMT',
	...
	tags: [
		...
		},
		{
			...
			title: 'Meera Sodha',
			bylineImageUrl:
				'https://i.guim.co.uk/img/uploads/2025/07/02/Meera_Sodha.jpg?width=300&quality=85&auto=format&fit=max&s=cf1e2357238c2057a10440548204da30',
			bylineLargeImageUrl:
				'https://i.guim.co.uk/img/uploads/2025/07/02/Meera_Sodha.png?width=300&quality=85&auto=format&fit=max&s=af6ee1ad88b1bb33adf850ba6b691654',
		},
		{
	...
	linkedData: [
		{
			...
			image: [
				'https://i.guim.co.uk/img/media/2b588fe2032633c03745b405a453d1ce9ea7c394/0_2279_3731_2239/master/3731.jpg?width=1200&height=630&quality=85&auto=format&fit=crop&precrop=40:21,offset-x50,offset-y0&overlay-align=bottom%2Cleft&overlay-width=100p&overlay-base64=L2ltZy9zdGF0aWMvb3ZlcmxheXMvdGctZGVmYXVsdC5wbmc&enable=upscale&s=55ad9850b660c1b8a42fc528722f4bbc',
	...
	openGraphData: {
		...
		'article:modified_time': '2025-12-02T08:27:00.000Z',
		'og:image:height': '720',
		'og:description':
		...
		'article:tag':
			'Vegan food and drink,Vegetables,Food,Chinese food and drink,Life and style,Main course,Snacks,Starter,Pancakes',
	...
	twitterData: {
		...
		'twitter:image':
			'https://i.guim.co.uk/img/media/2b588fe2032633c03745b405a453d1ce9ea7c394/0_2279_3731_2239/master/3731.jpg?width=1200&height=630&quality=85&auto=format&fit=crop&precrop=40:21,offset-x50,offset-y0&overlay-align=bottom%2Cleft&overlay-width=100p&overlay-base64=L2ltZy9zdGF0aWMvb3ZlcmxheXMvdGctZGVmYXVsdC5wbmc&s=8833e292fc2ffd9912aec091ef5eaa1b',
