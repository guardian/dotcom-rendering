	...
	mainMediaElements: [
		{
			...
			elementId: '86d2ddb1-b95f-4a24-9455-56d35f8bd6e2',
			imageSources: [
				{
					weighting: 'inline',
					srcSet: [
			...
			elements: [
				{
					...
					elementId: '895bd64c-f976-4d65-9f13-3d6f49c32ff8',
				},
				{
					_type: 'model.dotcomrendering.pageElements.PullquoteBlockElement',
					role: 'supporting',
					elementId: '2569487d-635e-4450-a8dc-7293f17acf9a',
				...
				},
				{
					...
					elementId: '6a26aef8-62ec-43be-a34d-59116fc1860c',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '63e3e048-4182-4219-8cfa-ace731160c72',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'a74227fc-d354-40f1-b196-4a8f268a1fce',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '271d4fe4-07b5-4f04-8c02-409360550ca7',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '18224aa6-047a-4b8a-a89b-384304d2f7ed',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'aeb5be1e-cdc7-48a0-8e50-713b06d4f06b',
				},
				{
					_type: 'model.dotcomrendering.pageElements.RichLinkBlockElement',
					prefix: 'Related: ',
					text: 'Tory plans to ‘level up’ the north are laughably inadequate | Polly Toynbee',
					elementId: 'fa236efd-50e9-42ef-a8b3-968a4be188b7',
					role: 'thumbnail',
				...
				},
				{
					...
					elementId: '1f66a39d-e263-4161-a4d9-3b50dc865044',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'd6e5b8ae-b47c-40dc-aa5c-b4f94ee0627e',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'f51e869b-628d-447c-9629-65e4f00e574b',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'ec52cede-1452-4bfd-bc85-c16d25ba260c',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					html: '<p>• John Harris is a Guardian columnist</p>',
					elementId: 'e908dc9d-99b4-4bf5-b4e9-fb306cc992d5',
				},
			],
			attributes: {
				pinned: false,
