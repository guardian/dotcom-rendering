...
export const Recipe: DCRArticleType = {
	frontendData: {
		slotMachineFlags: '',
		...
		mainMediaElements: [
			{
				...
				elementId: '43363719-aa4e-4f8b-bd5e-4e1df751307e',
			},
		],
		canonicalUrl:
		...
		blocks: [
			{
				...
				elements: [
					...
					},
					{
						...
						elementId: '1112d31e-2e86-48f5-9eb6-1c71f820218e',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '36a6e306-88f6-4284-96ac-91a1740f0c58',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '0af5ea86-e7d9-4d6b-b173-368eb5098474',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '364fc16b-4343-4657-9b15-075c8e7d73c1',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '32e1e4d9-d1e6-4b90-8924-b84bcf1822ce',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '857af2b6-dca6-4173-b130-4184d646b8db',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '7df5618b-9f6f-4d06-aba9-e32f8fa5d73b',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '7e4745e5-3415-4197-a7b5-fb77089dd50d',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '9e400745-b772-4b3c-8b6d-fb41d42db650',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>Serve the pancakes hot with the sauce for dipping or drizzling over the top.</p>',
						elementId: '4d76ab95-9f51-48be-9eb7-6803967120ac',
					},
				],
				attributes: {
					pinned: false,
