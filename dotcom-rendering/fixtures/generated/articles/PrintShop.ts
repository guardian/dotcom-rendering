...
export const PrintShop: DCRArticleType = {
	frontendData: {
		slotMachineFlags: '',
		main: '',
		subMetaSectionLinks: [
				...
				elements: [
					{
						...
						elementId: '07d28bf7-e9cd-419b-9e59-abedd93cdaf6',
					},
					{
						...
						elementId: '032fac58-9f8d-451d-9943-31f007a632b8',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p><em>Photograph: Gerry Cranham / Offside</em></p>',
						elementId: 'b88d031e-6acf-437c-8817-fbe88741a383',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p><em>Words: Jonny Weeks</em></p>',
						elementId: '1441fba3-088f-47a9-8fc1-ac2e99120ddc',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: 'fc3429f2-f84e-46fe-9606-477d3cc962b1',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p><strong>Price</strong> <br>£55 including free delivery (30x40cm print size).</p>',
						elementId: 'abbd89f4-2c43-4261-8431-402a6e6b0448',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: 'ca2ddfee-8ebf-4ea0-96c7-0a7485d7e954',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: 'a1d85dc9-29e4-4293-8f6d-672193ea8398',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: 'cdb96fab-d6d4-49d3-a351-370f64b743a6',
					},
				],
				attributes: {
					pinned: false,
