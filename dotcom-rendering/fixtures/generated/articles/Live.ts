...
export const Live: DCRArticleType = {
	frontendData: {
		slotMachineFlags: '',
		...
		mainMediaElements: [
			{
				...
				elementId: '3ba16963-eb80-4914-b8d5-fd3609703108',
			},
		],
		canonicalUrl:
				...
				elements: [
					{
						...
						elementId: '023c6ca2-1b2f-4330-8936-23c77f7ddac0',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>To recap:</p>',
						elementId: 'acfab430-0e36-4a35-811d-f7518dd5a39f',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: 'dd2d8827-e5a2-41f0-a733-9d1f74adabd2',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>#TBT</p>',
						elementId: '2dd8ffbf-972a-4b49-917d-f2fcd6c34258',
					},
					{
						...
						expired: false,
						duration: 142,
						elementId: '5148cdb9-c4a5-494d-84db-87a8f97dfd2e',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>#FF</p>',
						elementId: '4da06e6c-e223-40d6-a1a5-c4a16b4b2ee7',
					},
					{
						...
						source: 'Twitter',
						elementId: '71385455-6316-4179-a9c6-9c0d3a9d1201',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TweetBlockElement',
						...
						isThirdPartyTracking: false,
						source: 'Twitter',
						elementId: '53c723bb-9d17-444f-93cc-d60a8ecacb45',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: '8887d55a-8386-4ade-b662-71318847e930',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: 'b42e145c-e04a-4e40-a788-b4bb07231955',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '58424f5f-0bdd-49b9-b754-c5983bff25a9',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: '30482398-6e58-4495-baa4-d43c5cfe3b65',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>McGregor signs off:</p>',
						elementId: '4d9b8ff4-6aa8-4108-a488-b032c5e9a037',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '3736a0ae-bd75-4bd9-9960-abcf5f2beaa6',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: '30bf1b23-5723-43e2-a8fb-5dea6370d129',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: 'edb69a85-9210-48eb-a3a1-f07ba2edf675',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: '22b3990a-65ef-492f-bd4f-18daa0dd9bef',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>Answers include:</p>',
						elementId: '4127b773-9da6-4f2e-8b61-7646a48dbe38',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '6854ac0b-ab34-4151-bc1d-93ddcdb6f774',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: '265d6a2d-d5c2-4f46-9298-21b8d8fbf1f9',
					},
					{
						_type: 'model.dotcomrendering.pageElements.ImageBlockElement',
						media: {
						...
						elementId: '3f20d543-69ba-4444-ac00-18c8ce69fb89',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: 'a30e36d8-1eb1-482e-b366-47fadb30e1d6',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: 'e4dea968-4bc6-4099-b2f4-47e249a0da37',
					},
					{
						_type: 'model.dotcomrendering.pageElements.ImageBlockElement',
						media: {
						...
						elementId: 'b10f246d-048d-49e8-9244-2d0513b301e0',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: '1a2dbb41-0d0a-485f-92ad-0bb509d10348',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '1f183543-e0ae-42aa-91cd-09cae7575b74',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: '8c93f08b-1499-48a5-bd0c-c48d2dcbadda',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>That’s it for our live coverage of Nasa’s celebratory news conference and Q&amp;A following the successful landing of the rover Perseverance on Mars.</p>',
						elementId: '93578400-5226-4101-88b3-f317c81afd85',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>To recap:</p>',
						elementId: '9613b732-d2fd-42bd-bd8a-c57f47e1b6c7',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<ul>\n <li>The rover is “healthy” and undergoing systems testing.</li>\n <li>It already has beamed back stunning photos from the surface of <a href="https://www.theguardian.com/science/mars" data-component="auto-linked-tag">Mars</a> promising significant scientific discoveries ahead.</li>\n <li>The images include the first color images beamed directly from Mars as opposed to images touched up later.</li>\n <li>The rover documented its own touchdown via an ingenious system of booster rockets and a “space crane”.</li>\n <li>It landed in a “pool-table flat” crater in a prime location for searching for traces of ancient life.</li>\n <li>The wheeled rover could begin to move around its new home as early as late February.</li>\n <li>The rover’s mini helicopter could launch as early as April.</li>\n <li>Its broad mission is to stay on Mars for a couple years, gather data and harvest samples to be collected and returned to Earth on a future mission.</li>\n <li>The point is to determine whether there was life on Mars and subsidiary questions.</li>\n <li>The team at Nasa is very happy and excited, “on cloud nine” in a “weird, dreamlike state”... with lots of work ahead.</li>\n</ul>',
						elementId: 'e9ad0b00-3d3a-4070-a861-24558d564df7',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: '9b10a25a-5bf5-40f7-9953-b6a4d9ba9130',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: 'b60b80b8-4173-4b6c-b44a-9ad8a52b7156',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '6688c12a-a2ac-4611-9d2b-e34df89acdc1',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: 'baac617e-20ee-4eb9-ae8a-fd705d3b1384',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: 'a6fad5c9-f337-4306-9e23-eed605362cd3',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>Guardian science correspondent Natalie Grover reports of Percy’s mission:</p>',
						elementId: 'c9a2c07c-13aa-46f3-9de1-5d2179470ca8',
					},
					{
						...
						elementId: '26698e0f-1d26-48f1-9037-2bc7b2c634c2',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: 'e97be1d0-a064-429f-a176-dd9a0e91d66d',
					},
					{
						...
						elementId: '84f8a79a-7df2-417a-b061-9d7a0c44974d',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '55dcbd08-c6d4-456b-a6e8-ab9eb9d902bb',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>Thank you for joining our live coverage.</p>',
						elementId: 'a1b1145d-7506-465f-a312-b15a324bb2b0',
					},
				],
				attributes: {
					pinned: false,
