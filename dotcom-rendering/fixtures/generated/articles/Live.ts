	...
	mainMediaElements: [
		{
			...
			elementId: '7a1af8b9-35af-4908-ba01-7b1760fed109',
		},
	],
			...
			elements: [
				{
					...
					elementId: '192b2c92-eb4d-4c4d-8dc7-2043d80f99a3',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					html: '<p>To recap:</p>',
					elementId: '3e4cc1e5-c80a-4b8a-a1d2-900a2e2afbd2',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '159d7199-2ba5-4653-9c2b-95ca8ad13e29',
				},
			],
			...
			elements: [
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					html: '<p>#TBT</p>',
					elementId: 'ee8ba656-83e9-4f6b-839c-65cd1e142315',
				},
				{
					...
					expired: false,
					duration: 142,
					elementId: '89535a0a-f37b-4099-8c9f-dec43b95b248',
				},
			],
			...
			elements: [
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					html: '<p>#FF</p>',
					elementId: 'd77a4717-3e16-4dba-bd13-1f3075cab305',
				},
				{
					...
					source: 'Twitter',
					elementId: 'b2dde232-01dd-4e42-8067-b3538c9de0f5',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TweetBlockElement',
					...
					isThirdPartyTracking: false,
					source: 'Twitter',
					elementId: '464a765e-69ef-4e9a-940d-04cbae69cd5d',
				},
			],
			...
			elements: [
				{
					...
					elementId: '79031681-a999-4128-82b7-3c11e7e68d02',
				},
			],
			...
			elements: [
				{
					...
					elementId: '0ed3a136-0caa-4a47-a0e2-f97716fd80b6',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'b7df1f4c-95a5-4113-bd76-50c0507e8f64',
				},
			],
			...
			elements: [
				{
					...
					elementId: '6ba25ddf-f6ce-4c90-849b-b760441f534c',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					html: '<p>McGregor signs off:</p>',
					elementId: '774b89b7-5f5d-4808-b82d-38a1ed6f8afc',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '8886fc31-0151-4dbf-93c9-ab260750726f',
				},
			],
			...
			elements: [
				{
					...
					elementId: '8d0b2881-ae2a-4c7e-906d-1be6008c908d',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '96f2f3f8-f7a6-4123-b704-427d9905a621',
				},
			],
			...
			elements: [
				{
					...
					elementId: '8a01d511-eb67-4620-b49b-a11051273ecf',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					html: '<p>Answers include: </p>',
					elementId: '91534f2e-cd6d-48b0-b5dd-43d5d56eff15',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'a7cbdf22-2433-4e77-8706-bf058e4bf041',
				},
			],
			...
			elements: [
				{
					...
					elementId: '8764a917-c459-4c10-a34e-33df59e1c13b',
				},
				{
					_type: 'model.dotcomrendering.pageElements.ImageBlockElement',
					media: {
					...
					elementId: 'c7d7b869-4493-4862-903d-674f4cff58d7',
				},
			],
			...
			elements: [
				{
					...
					elementId: 'f663bf7e-f553-49f4-ab13-f70b9770991d',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'ff43416e-c006-495a-bdd7-f7cca8aa5dad',
				},
				{
					_type: 'model.dotcomrendering.pageElements.ImageBlockElement',
					media: {
					...
					elementId: 'c8b29ad2-b26c-4cce-b549-5ed7e6b0128a',
				},
			],
			...
			elements: [
				{
					...
					elementId: 'ac3181a9-3dc3-4205-8a73-ee77f536c6a3',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'c201cabc-8b70-4d36-926d-93eadb3cb817',
				},
			],
			...
			elements: [
				{
					...
					elementId: 'cf68266c-9a08-4f3f-ba16-165a07352e4c',
				},
			],
