	...
	mainMediaElements: [
		{
			...
			elementId: 'f77f01b4-6517-4372-80f3-a9cc972384e9',
			position: 1,
			lightbox: {
				caption:
					'So brilliant you can only boggle ... Ncuti Gatwa as Eric in Sex Education.',
			...
			elements: [
				{
					...
					elementId: '02e1500d-400e-4f6f-942c-e80cb0b283c0',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'eaba02b6-698b-4189-8a29-a22e6ccc479c',
				},
				{
					...
					elementId: '6fbad1d6-b4e9-47dc-b776-48de225b2f9b',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '11bfa953-5b1a-4570-a486-08765837f031',
				},
				{
					_type: 'model.dotcomrendering.pageElements.ImageBlockElement',
					media: {
					...
					elementId: '236239df-9665-4dce-943f-89b1d4faabb5',
					position: 2,
					lightbox: {
						caption:
							'Relishing every moment … Gillian Anderson as Jean.',
				...
				},
				{
					...
					elementId: 'e282025f-623a-4ba7-88bf-98d1b5f88831',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'a7eeaa58-2913-4ab9-98be-ed94904371c7',
				},
			],
			attributes: {
				pinned: false,
