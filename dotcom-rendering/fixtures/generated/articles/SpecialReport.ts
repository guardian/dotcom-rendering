	...
	mainMediaElements: [
		{
			...
			elementId: 'e0d18d28-8bd1-4a6b-89af-84e27be4edae',
		},
	],
	canonicalUrl:
			...
			elements: [
				{
					...
					elementId: '58e587b0-984c-470e-b3ab-fe191c326f42',
				},
				{
					...
					elementId: 'fce5b1b9-a0d4-4ce2-9204-2edfe1831cb5',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>End</strong><strong> fossil fuel subsidies</strong></h2>',
					elementId: 'c14bf4f5-3387-4c4f-9716-8220e2fc903f',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'ee38b464-7b43-4f56-a493-b888f874ade1',
				},
				{
					...
					credit: '',
					elementId: '84bb6cb3-865d-43da-8db0-e5c636cab16f',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Put a price on carbon</strong></h2>',
					elementId: 'df3eb3e9-b573-4183-b431-8522664d4708',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'f846b959-4736-40c7-821d-bedb8586eee9',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '04eb635e-85ac-4758-a1ae-48f62c154154',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Stop flaring</strong></h2>',
					elementId: 'f5defe9f-80c8-4996-a097-37d2000611ac',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '85017b5a-bae3-4a25-8b67-85b926cbe094',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Roll out large scale carbon capture and storage</strong></h2>',
					elementId: '72c33496-50a2-41be-adb6-753d35d828e8',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'ba14f4b1-d08a-444a-b9ca-14b5377741b7',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Halt investment in fossil fuels</strong></h2>',
					elementId: '56cd6abd-f55f-4af7-b964-1ba48038c9a8',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'bcf63746-fe22-46b7-aa37-5a6a080388f0',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Establish market metrics on climate change</strong></h2>',
					elementId: '75b96a36-f7e4-4c28-a2c7-313f9b1dcc18',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'ecf2af84-f77a-4509-82da-26228e1a14b6',
				},
			],
			attributes: {
				pinned: false,
