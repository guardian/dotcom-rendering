	...
	mainMediaElements: [
		{
			...
			elementId: '58bd636d-0ab6-4965-bb62-2d9cafa561d4',
		},
	],
			...
			elements: [
				{
					...
					elementId: 'd6acd5de-1fae-4fc3-a0e1-4980fe9b75a5',
				},
				{
					...
					elementId: '60b88e26-3334-4e74-b96b-b68536ffcaee',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>End</strong><strong> fossil fuel subsidies</strong></h2>',
					elementId: '257770b3-abf6-41e0-8133-f4782fadca54',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'f0044a69-290c-4838-b343-47940cf6b7ea',
				},
				{
					...
					credit: '',
					elementId: 'efae654f-8f92-4406-936d-c7ba13e8b161',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Put a price on carbon</strong></h2>',
					elementId: 'dc270fe5-9871-4626-a6b7-3666be6b998b',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'afd6af69-f716-40d0-a507-76ac815c0504',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '65352765-d569-4675-a3dd-59e920c82702',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Stop flaring</strong></h2>',
					elementId: '385c4e4a-830c-446f-af66-3033796d94e5',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '864b8f8b-5ccb-4198-95f3-9940a8ff46d5',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Roll out large scale carbon capture and storage</strong></h2>',
					elementId: '4038a760-cb33-48c1-a946-51094f3a59d9',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '101e4ddf-720b-4385-bfe0-444032d304d4',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Halt investment in fossil fuels</strong></h2>',
					elementId: '53937da9-8b62-4e69-9ef3-c54706f8d551',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '116727e9-bafb-4794-a74d-a31b00fe6fbb',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Establish market metrics on climate change</strong></h2>',
					elementId: 'd4f2050f-88d7-42b0-901e-055a43983e32',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '60e931e8-7186-4b2c-951a-efe12dcb4cf7',
				},
			],
			attributes: {
				pinned: false,
