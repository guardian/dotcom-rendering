...
export const SpecialReport: DCRArticleType = {
	frontendData: {
		slotMachineFlags: '',
		...
		mainMediaElements: [
			{
				...
				elementId: '46eca916-317d-4972-a88b-f34e5f138dbc',
			},
		],
		canonicalUrl:
				...
				elements: [
					{
						...
						elementId: '001daf7a-1ec6-40dd-a6be-8e73ca83d845',
					},
					{
					...
					},
					{
						...
						elementId: 'aef9ddff-8898-4be2-8ab1-7f040eb27fcf',
					},
					{
						...
						credit: '',
						elementId: '5bec229c-a745-4979-b1a5-cb3fefa24490',
					},
					{
						_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
						html: "<h2 id='put-a-price-on-carbon'><strong>Put a price on carbon</strong></h2>",
						elementId: 'dec68ea5-5b71-430b-b5ae-0855529f96cc',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '18fd3b5d-2178-4fe3-9fcf-490b59319d06',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '5632b5a5-5a77-4a4d-9fb9-ac5f6e3a6178',
					},
					{
						_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
						html: "<h2 id='stop-flaring'><strong>Stop flaring</strong></h2>",
						elementId: '611e9bad-3487-4417-8bc9-c84e785be46a',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '338d2eca-011a-44f9-a820-f1d626eabd44',
					},
					{
						_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
						...
						elementId: 'abe2284e-0319-4bf9-93f7-420745e3dda3',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '9996d91e-5cd7-4763-95ba-aa6790a0978d',
					},
					{
						_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
						html: "<h2 id='halt-investment-in-fossil-fuels'><strong>Halt investment in fossil fuels</strong></h2>",
						elementId: 'df691351-1684-4fb4-a260-1d423c772a7d',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					},
					{
						...
						elementId: '66fc28a0-6264-42cd-ae4a-11cd9c855f42',
					},
				],
				attributes: {
					pinned: false,
