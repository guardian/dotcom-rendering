	...
	mainMediaElements: [
		{
			...
			elementId: '8ae314ed-2657-4c1a-9100-1b16017d118c',
		},
	],
			...
			elements: [
				{
					...
					elementId: '473cb453-57fd-460a-9a8e-4ff55c8ffb76',
				},
				{
					...
					elementId: '480ead64-ce10-468a-bb90-593f3e217e98',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>End</strong><strong> fossil fuel subsidies</strong></h2>',
					elementId: 'f342e411-753c-4a23-be4d-d9f574ecff3c',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '3472afa9-373c-407f-bb97-4911aa385d6a',
				},
				{
					...
					credit: '',
					elementId: 'ccdbc504-42e7-45a3-b2ec-866760933e9a',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Put a price on carbon</strong></h2>',
					elementId: 'edbeb0df-96d0-4b6a-946d-9413c43825fa',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '2749cca5-c4a2-403b-acf9-a7f79f9c8988',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'efe3392b-7261-470e-aecd-76fe7adbe03b',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Stop flaring</strong></h2>',
					elementId: '5e1c8b4d-5200-4d48-9b49-f0b46325ba88',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'e5a980e0-9b98-4640-9c69-1fc81661e319',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Roll out large scale carbon capture and storage</strong></h2>',
					elementId: '28bb8f01-4e4e-49a1-ab98-13dbfc4b5926',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '05b0988a-ce32-475c-8dae-787167359ddc',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Halt investment in fossil fuels</strong></h2>',
					elementId: '65e3b65d-5c79-44fb-852f-04eaca9f76ae',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '6966ecd0-8515-457a-81e2-0d117cc3b2e9',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Establish market metrics on climate change</strong></h2>',
					elementId: 'd42471a5-ac02-4fc8-8f44-4312819ffb0a',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '4192e737-d93d-4bcc-b721-fa6f59157edc',
				},
			],
			attributes: {
				pinned: false,
