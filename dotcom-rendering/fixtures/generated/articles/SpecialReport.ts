	...
	mainMediaElements: [
		{
			...
			elementId: '8448dca1-7239-40d6-81c8-5d3622fb034e',
		},
	],
			...
			elements: [
				{
					...
					elementId: '400b6ab4-75c8-4f7a-a890-d482e785c3fa',
				},
				{
					...
					elementId: '150226f4-dc14-4407-ace9-9560e43c9b1e',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>End</strong><strong> fossil fuel subsidies</strong></h2>',
					elementId: '3bdd4b61-e1c3-4285-a130-32903a91392d',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'b8806b26-3ba9-45ba-afbe-a720dd49d184',
				},
				{
					...
					credit: '',
					elementId: '5e89c72d-5916-46f9-b6a7-92a2f7911a74',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Put a price on carbon</strong></h2>',
					elementId: 'e35b8a98-ac00-4df2-b79f-db191a938869',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '856ca53a-e3ae-419d-87ea-4d0ed23d8a1c',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'd66b511e-3d18-4273-abf0-b15ea818f098',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Stop flaring</strong></h2>',
					elementId: 'be277a79-64f5-4b8b-8352-b01a2325cd53',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'e4a3eeaa-bba9-460d-a72f-244e65923e89',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Roll out large scale carbon capture and storage</strong></h2>',
					elementId: '409b89b7-642c-45a2-bbbc-5d774d00d876',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'a450f0f2-cc33-4d19-a902-437365c863ab',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Halt investment in fossil fuels</strong></h2>',
					elementId: '2d5cb84f-b4c8-4863-9b0a-f5a7fd6eaa03',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'e4c8729c-df24-4cd0-b83f-42c301fefe2d',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Establish market metrics on climate change</strong></h2>',
					elementId: 'e4c38665-caa0-45ca-9535-da485006dba1',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '1a8027eb-30ef-49c9-b71d-50d43dd9fb68',
				},
			],
			attributes: {
				pinned: false,
