	...
	mainMediaElements: [
		{
			...
			elementId: '1f76d5e0-3c83-40c7-a0ff-cce23af5b869',
		},
	],
			...
			elements: [
				{
					...
					elementId: '577a0217-cb8e-42f0-95ac-b19a76f4edbc',
				},
				{
					...
					elementId: 'e081d113-8e14-43f5-9380-7b69bc96e320',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>End</strong><strong> fossil fuel subsidies</strong></h2>',
					elementId: '113cc7b5-e8cd-478d-bfbe-4b3409cba7f9',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '3ba7321d-4d4b-4546-8e03-d9b07fefd0e4',
				},
				{
					...
					credit: '',
					elementId: '02309cc6-362a-47c1-9cf5-2009a19a35f6',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Put a price on carbon</strong></h2>',
					elementId: '059a0955-5506-4656-9c05-b6c2df668702',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '58fe493f-a5c4-4fab-9fd9-d46d988c0058',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '1230a89c-7699-40d1-a1af-12d6de50f032',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Stop flaring</strong></h2>',
					elementId: '76069664-e0d9-48d8-8362-f6bfef492c28',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '3d71412d-27c6-49f5-9c68-3a3b5719f499',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Roll out large scale carbon capture and storage</strong></h2>',
					elementId: '465e1b39-e703-4889-ba7c-cab8e84a7632',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'ce2518ff-21e7-43b7-ad05-0af42df7959b',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Halt investment in fossil fuels</strong></h2>',
					elementId: 'd4702ad2-c6a4-4a34-9162-da517f92be52',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: 'b719af60-983c-4778-a6c6-5e6908024b72',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: '<h2><strong>Establish market metrics on climate change</strong></h2>',
					elementId: '21435bdc-e7b7-4a25-9659-bd6c5dda4693',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '7b4104dd-ba12-4b8d-bb0c-a17eef476663',
				},
			],
			attributes: {
				pinned: false,
