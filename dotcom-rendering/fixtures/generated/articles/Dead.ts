...
export const Dead: DCRArticleType = {
	frontendData: {
		slotMachineFlags: '',
		...
		mainMediaElements: [
			{
				...
				elementId: 'a4021614-99fa-44c4-a31a-480230996b24',
			},
		],
		canonicalUrl:
				...
				elements: [
					{
						...
						elementId: '9ba7dc39-a79c-437e-95b0-ef02e7fb48cf',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>To recap:</p>',
						elementId: 'bd8f1891-a0d8-485d-a0d7-4d28d79501c3',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: 'f2a75d99-6d83-437a-b7de-ede9b596a9fb',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>#TBT</p>',
						elementId: '35f5f31d-cd8d-4777-b09e-14e6a08c67f1',
					},
					{
						...
						expired: false,
						duration: 142,
						elementId: '8946371f-a37a-4d13-8dff-df873a2479e9',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>#FF</p>',
						elementId: '7205d4f9-c63b-40a1-9b43-096811615111',
					},
					{
						...
						source: 'Twitter',
						elementId: '1e709551-ec9a-442b-a1a4-9f4ffeed98c2',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TweetBlockElement',
						...
						isThirdPartyTracking: false,
						source: 'Twitter',
						elementId: '6effd97a-abdb-4317-88fd-85bc6905310d',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: '5ffde238-1418-40f1-9efb-6b31a564c8a7',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: 'd08a57fa-1fd8-472a-8271-a73c52c12b05',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '312da6b3-0f45-4e2d-a4d0-343af3c61de7',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: '8cf7997f-d9e8-4a72-85ea-28e913d79570',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>McGregor signs off:</p>',
						elementId: '5e4822ba-e054-4e2d-b528-b7a5347333da',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '225a11db-9c15-494f-ac08-1f785136a374',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: '31d0a171-2288-41b1-a396-32c8384b0dbd',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '3a71c69b-ecf6-47f7-9176-6ba9ee7b9867',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: '529b766f-9a1b-4ac1-9de0-560330498e85',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>Answers include:</p>',
						elementId: '72e13487-155d-4e56-8c7e-ea11e1199b87',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '68bec863-ebbf-4f87-bb5b-7146b617a460',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: 'a70fb426-85e6-47b8-b7aa-69e339f27634',
					},
					{
						_type: 'model.dotcomrendering.pageElements.ImageBlockElement',
						media: {
						...
						elementId: 'bef43c01-a388-4eb1-bfbb-92ef060d8da2',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: '1f7fabb7-ccf8-4ea5-9bfc-4cc92b4c69cb',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: 'b74c2ffa-b399-4aef-84f4-5a0fe16a4e84',
					},
					{
						_type: 'model.dotcomrendering.pageElements.ImageBlockElement',
						media: {
						...
						elementId: '1e4f4c8b-3381-4e10-bd32-07149d53a445',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: 'ed324285-77a7-44db-a068-5c877503c980',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '17b2f7d9-3d7b-486d-b5f2-47d9e13ead18',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: 'c1350398-4450-4583-863a-c89507b743fb',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>That’s it for our live coverage of Nasa’s celebratory news conference and Q&amp;A following the successful landing of the rover Perseverance on Mars.</p>',
						elementId: 'cc68b36e-86ad-46e7-83af-e3888679d68b',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>To recap:</p>',
						elementId: '790adfb1-8816-4687-9b8a-db3a87ca7fd4',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<ul>\n <li>The rover is “healthy” and undergoing systems testing.</li>\n <li>It already has beamed back stunning photos from the surface of <a href="https://www.theguardian.com/science/mars" data-component="auto-linked-tag">Mars</a> promising significant scientific discoveries ahead.</li>\n <li>The images include the first color images beamed directly from Mars as opposed to images touched up later.</li>\n <li>The rover documented its own touchdown via an ingenious system of booster rockets and a “space crane”.</li>\n <li>It landed in a “pool-table flat” crater in a prime location for searching for traces of ancient life.</li>\n <li>The wheeled rover could begin to move around its new home as early as late February.</li>\n <li>The rover’s mini helicopter could launch as early as April.</li>\n <li>Its broad mission is to stay on Mars for a couple years, gather data and harvest samples to be collected and returned to Earth on a future mission.</li>\n <li>The point is to determine whether there was life on Mars and subsidiary questions.</li>\n <li>The team at Nasa is very happy and excited, “on cloud nine” in a “weird, dreamlike state”... with lots of work ahead.</li>\n</ul>',
						elementId: '30303abc-855e-443c-8e41-a996ccf4d1d6',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: '0216f3d0-a289-478b-85fa-3dcad39fe80a',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: '04d89587-74fd-4845-aaf5-4847ed06051d',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: '4eb5a074-f5e4-47bd-ac9d-f4bc5d1cff4c',
					},
				],
				attributes: {
					pinned: false,
				...
				elements: [
					{
						...
						elementId: 'c0e49c98-36a1-4299-b244-05089109052a',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: 'c7c99aa9-68bd-4f5b-90d3-eb8b46513d19',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>Guardian science correspondent Natalie Grover reports of Percy’s mission:</p>',
						elementId: 'd774dcff-7251-4237-89e7-8cd0cd0f1d14',
					},
					{
						...
						elementId: 'ec91d32b-e3c1-4da2-b5b6-dad9fc7edd95',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: 'beab0253-344b-4dcb-a725-21e1ff005fe5',
					},
					{
						...
						elementId: '0abb53d3-2599-45bd-8490-1350b6bff047',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						...
						elementId: 'bc2bd881-9ce5-4df7-87f6-e30717e6ff55',
					},
					{
						_type: 'model.dotcomrendering.pageElements.TextBlockElement',
						html: '<p>Thank you for joining our live coverage.</p>',
						elementId: '9dc034d9-5f6e-4eb9-ad5c-10c4d3fab6ec',
					},
				],
				attributes: {
					pinned: false,
