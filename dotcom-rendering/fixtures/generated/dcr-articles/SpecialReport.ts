	...
	mainMediaElements: [
		{
			...
			elementId: '1e932ff5-2c76-4857-9bcc-061c27e43663',
			imageSources: [
				{
					weighting: 'inline',
					srcSet: [
			...
			elements: [
				{
					...
					elementId: 'd50b7605-96cb-4147-80cb-cd14d4be8099',
				},
				{
				...
				},
				{
					...
					elementId: 'ac708ce0-24f2-4aad-a7c2-c630b225281f',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '69fda33f-c18a-46a1-9c47-b0ae033eb56a',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '660e1be3-a480-4961-a9dd-7591f721e1cb',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: "<h2 id='stop-flaring'><strong>Stop flaring</strong></h2>",
					elementId: '268cff81-d430-4250-9c38-650f340ae13c',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '4ddc7538-da77-41bf-89f1-fd0ce1658ebd',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					...
					elementId: '7f8f13c1-687b-4cf7-b47b-9fd234dc08ed',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '531e7be8-2a0d-41a7-9a52-6fa7aafc03b4',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: "<h2 id='halt-investment-in-fossil-fuels'><strong>Halt investment in fossil fuels</strong></h2>",
					elementId: '20e06716-5f9f-45ef-a30e-0d5b5e65a0c1',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
				...
				},
				{
					...
					elementId: '9f430997-1c27-414b-87b6-ecc0e551747f',
				},
			],
			attributes: {
				pinned: false,
