	...
	mainMediaElements: [
		{
			...
			elementId: '6aa32489-d580-4f1d-b9b2-0056fd102830',
			imageSources: [
				{
					weighting: 'inline',
					srcSet: [
			...
			elements: [
				{
					...
					elementId: '5605ec7b-9733-4c62-bfaa-5e5d691abd11',
				},
				{
				...
				},
				{
					...
					elementId: 'fb7c0c38-8058-4adf-952c-65b89725bece',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '15b95b2e-8e59-4f24-b669-7ae95ad4a948',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '010e1295-ee7b-4d1f-86bf-5bb67a29307a',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: "<h2 id='stop-flaring'><strong>Stop flaring</strong></h2>",
					elementId: '174ad8b2-c5d7-4ed6-a7df-15a50430169e',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '73bb30be-fde5-4103-bbae-c12125ff3b5c',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					...
					elementId: '6c96c8e4-96ef-4c27-b4c8-07a1b9f24c64',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
					...
					elementId: '881bae8f-8780-4ba1-b8a8-d1c6df9f4afb',
				},
				{
					_type: 'model.dotcomrendering.pageElements.SubheadingBlockElement',
					html: "<h2 id='halt-investment-in-fossil-fuels'><strong>Halt investment in fossil fuels</strong></h2>",
					elementId: 'f73f691d-4813-465b-9fc1-470151833e5c',
				},
				{
					_type: 'model.dotcomrendering.pageElements.TextBlockElement',
				...
				},
				{
					...
					elementId: '8e393d1b-2c22-4a45-a884-25406bc3e8cb',
				},
			],
			attributes: {
				pinned: false,
