export const mostReadGeo = {
	...
	trails: [
		...
		},
		{
			...
			linkText: 'New Zealand v Australia: fourth T20 international – live!',
			showByline: false,
			byline: 'Geoff Lemon',
			image:
			...
			headline: 'New Zealand v Australia: fourth T20 international – live!',
		...
		},
		{
			...
			linkText: "Brexit: EU to launch legal proceedings against UK 'very soon'",
			showByline: false,
			byline: 'PA Media',
			image:
			...
			headline: "Brexit: EU to launch legal proceedings against UK 'very soon'",
