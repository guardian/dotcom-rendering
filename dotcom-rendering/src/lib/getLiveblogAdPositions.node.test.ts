...
void nodeDescribe('get liveblog ad positions', () => {
	...
	void nodeIt(
		'should insert an ad after the first block if two blocks',
		() => {
			assert.deepEqual(
	...
	void nodeDescribe('many blocks', () => {
		...
		void nodeIt(
			'On desktop, it should insert an ad after every fourth block given repeated text elements of 1,000 characters',
			() => {
				assert.deepEqual(
		...
		void nodeIt(
			'On mobile, it should insert an ad after every second block given repeated text elements of 1,000 characters',
			() => {
				assert.deepEqual(
		...
		void nodeIt(
			'On desktop, it should not insert more that 8 slots',
			() => {
				assert.equal(
		...
		void nodeIt('On mobile, it should not insert more that 8 slots', () => {
			assert.equal(
