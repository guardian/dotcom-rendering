...
void describe('isLight', () => {
	void it('should return the correct response for dark hex colours', () => {
		for (const colour of [
			'#791a4e',
			'#644f4e',
			'#7f4e2a',
	...
	void it('should return the correct response for light hex colours', () => {
		for (const colour of ['#ea3eee', '#97dc45', '#7ec621', '#54dbb6']) {
			assert.equal(isLight(colour), true);
		}
	});

	void it('should return the correct response for 3 digit hex colours', () => {
	...
	void it('should handle if the # is missing', () => {
		assert.equal(isLight('97dc45'), true);
		assert.equal(isLight('000'), false);
	});

	void it('should handle if the colour string is invalid', () => {
