...
void describe('takeFirst', () => {
	void it('Always returns the correct array length when the array is one less, the same as, or one more than n', () => {
		const results = [
		...
		const expectedLengths = [
			1, 1, 0, 2, 2, 1, 3, 3, 2, 4, 4, 3, 5, 5, 4, 6, 6, 5, 7, 7, 6, 8, 8,
			7, 9, 9, 8, 10, 10, 9, 11, 11, 10, 12, 12, 11,
		];
