...
void describe('addNotificationsToDropdownLinks', () => {
	void it('augments dropdown links with notifications', () => {
		const links = [
			{
				id: 'account_overview',
	...
	void it('adds multiple notification messages to a link', () => {
		const links = [
			{
				id: 'account_overview',
				url: `https://example.com/account_overview`,
	...
	void it('adds new notifications if target already has notifications', () => {
		const links = [
			{
				id: 'account_overview',
				url: `https://example.com/account_overview`,
