...
describe('getZIndex', () => {
	it('gets the correct zindex for group and sibling', () => {
		...
		expect(getZIndex('editionDropdown')).toBe('z-index: 18;');
		expect(getZIndex('summaryDetails')).toBe('z-index: 17;');
		expect(getZIndex('toast')).toBe('z-index: 16;');
		expect(getZIndex('onwardsCarousel')).toBe('z-index: 15;');
		expect(getZIndex('myAccountDropdown')).toBe('z-index: 14;');
		expect(getZIndex('searchHeaderLink')).toBe('z-index: 13;');
		expect(getZIndex('TheGuardian')).toBe('z-index: 12;');
		expect(getZIndex('editionSwitcherBanner')).toBe('z-index: 11;');
		expect(getZIndex('headerWrapper')).toBe('z-index: 10;');
		expect(getZIndex('tagLinkOverlay')).toBe('z-index: 9;');
		expect(getZIndex('tagLink')).toBe('z-index: 8;');
