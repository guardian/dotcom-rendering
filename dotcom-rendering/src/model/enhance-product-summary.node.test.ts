...
void describe('enhanceProductSummary', () => {
	void it('enhances product summary elements with its selected product elements', () => {
	...
	void it('enhances product summary elements with the correct CTA indices', () => {
