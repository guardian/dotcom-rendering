...
const PLATFORM_TREATS: TreatType[] = [
	{
		links: [
			{
				linkTo:
					'/info/2015/dec/08/daily-email-us?INTCMP=gdnwb_treat_election_today_us',
	...
	},
	{
		links: [
			...
			{
				linkTo:
					'/books/ng-interactive/2022/aug/19/this-months-best-paperbacks-jan-morris-katie-kitamura-and-more',
		...
		editionId: 'UK',
		imageUrl: 'https://uploads.guim.co.uk/2022/08/19/culture-nugget-august.png',
...
const getPlatformTreats = (
	...
	return PLATFORM_TREATS.filter((treat) => {
		...
		const matchesEdition = !treat.editionId || treat.editionId === editionId;
