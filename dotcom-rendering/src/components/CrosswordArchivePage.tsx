...
import { CrosswordArchiveLayout } from '../layouts/CrosswordArchiveLayout';
...
export const CrosswordArchivePage = ({ archivePage, NAV }: Props) => {
	const format = {
			...
			<Island priority="critical">
				<Metrics
					commercialMetricsEnabled={
						!!archivePage.config.switches.commercialMetrics
					}
					tests={archivePage.config.abTests}
				/>
			</Island>
			<CrosswordArchiveLayout archivePage={archivePage} NAV={NAV} />
		</StrictMode>
	);
};
