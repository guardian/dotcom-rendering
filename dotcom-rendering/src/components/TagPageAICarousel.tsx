...
import { StorylineSample } from './TagPageAI.importable';
import { Tag } from 'node_modules/@guardian/bridget';
import { TagPageAIStorylineVignette } from './TagPageAIStorylineVignette';
...
export const TagPageAICarousel = ({
	content,
	...
	const vignetteCount = content.vignette.length;
	...
	return (
		<div>
			...
			>
				{content.vignette.map((vignette, index) => {
					const loading = index > 0 ? 'lazy' : 'eager';
					return (
						<li css={carouselItemStyles} key={index}>
							<TagPageAIStorylineVignette vignette={vignette} />
						</li>
					);
				})}
			</ul>
