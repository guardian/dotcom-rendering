...
import { GeneratedSummaryLayout } from '../layouts/GeneratedSummaryLayout';
...
/**
 * @description
 * This GeneratedSummaryPage is a high level wrapper for generated summary pages on Dotcom. Sets strict mode and some globals
 *
 * @param {Props} props
 * @param {DCRFrontType} props.front - The article JSON data
 * @param {NAVType} props.NAV - The article JSON data
 * */
export const GeneratedSummaryPage = ({ front, NAV }: Props) => {
	...
	return (
		<StrictMode>
			...
			<GeneratedSummaryLayout front={front} NAV={NAV} />
		</StrictMode>
	);
};
