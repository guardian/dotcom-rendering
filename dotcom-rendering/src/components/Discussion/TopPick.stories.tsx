...
import type { ResponseType, SignedInUser } from '../../lib/discussion';
...
const commentContributor: ResponseType = {
	...comment,
	userProfile: {
		...comment.userProfile,
		badge: [
...
const commentWithShortBody: ResponseType = {
	...comment,
	body: "<p>It's still there FrankDeFord - and thanks, I will pass that on</p>",
};

const contributorCommentWithShortBody: ResponseType = {
	...comment,
	userProfile: {
		...comment.userProfile,
		badge: [
