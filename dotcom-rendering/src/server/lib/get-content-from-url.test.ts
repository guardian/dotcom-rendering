...
describe('URL parser', () => {
	...
	test('parse source URL when multiple queries are present', () => {
		const req = {
			path: '/Article/https%3A%2F%2Fwww.theguardian.com%2Fpolitics%2Flive%2F2022%2Fapr%2F13%2Fboris-johnson-uk-politics-live-rishi-sunak-partygate-lockdown?dcr=true&live=true',
		};
		const parsedURL =
			'https://www.theguardian.com/politics/live/2022/apr/13/boris-johnson-uk-politics-live-rishi-sunak-partygate-lockdown?dcr=true&live=true';
