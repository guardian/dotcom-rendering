...
export const handleAMPArticle: Handler = async (context) => {
	...
	const scripts = [...extractScripts(elements, article.mainMediaElements)];
...
export const handlePerfTest: Handler = (context, next) => {
