...
export const RecipeLayout = (props: WebProps | AppProps) => {
	...
	// if (
	// 	url ==
	// 	'https://www.theguardian.com/food/2023/may/16/nigel-slater-recipe-for-apricots-with-french-toast'
	// ) {
	// 	return (
	// 		<Island>
	// 			<RecipeRender recipeId={getRecipeId(url)} />
	...
	// } else if (
	// 	url ==
	// 	'https://www.theguardian.com/food/2023/may/15/1-pound-meals-budget-midweek-meal-chickpeas-nancy-birtwhistle-vegan'
	// ) {
	// 	return (
	// 		<Island>
	// 			<RecipeRender recipeId={2} />
	// 		</Island>
	// 	);
	// } else {
	// 	return (
	// 		<Island>
	// 			<RecipeRender recipeId={3} />
	// 		</Island>
	// 	);
	// }
};
...
// 		<>
// 			{' '}
// 			{renderingTarget === 'Apps' && <div>test</div>}
// 			{renderingTarget === 'Web' && (
