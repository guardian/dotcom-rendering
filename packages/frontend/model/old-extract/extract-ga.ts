...
export const extract = (data: any): GADataType => {
    ...
    return {
        ...
        contentType: getString(data, 'page.contentType', '')
            ...
            .split(' ')
            .join(''),
        commissioningDesks: getString(data, 'page.tags.commissioningDesks', ''),
        contentId: getString(data, 'page.contentId', ''),
        authorIds: getString(data, 'page.tags.authorIds', ''),
        keywordIds: getString(data, 'page.tags.keywordIds', ''),
        toneIds: getString(data, 'page.tags.toneIds', ''),
