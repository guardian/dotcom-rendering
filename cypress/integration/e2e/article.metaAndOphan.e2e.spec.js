...
describe('E2E Page rendering', function () {
	...
	describe('for WEB the document renders with the correct meta and analytics info', function () {
		...
		it('Subnav ophan data-link-name exists with correct value', function () {
			...
			cy.get(
				`a[data-link-name="nav2 : subnav : /money/pensions"]`,
			).should('have.length', 0); // Ensure we don't parse in an accidental slash
		});
		...
		it('Sample of script tags have the correct attributes', function () {
			getExists(`script[defer][type="module"][src="/assets/react.js"]`);
			getExists(`script[defer][nomodule][src="/assets/react.legacy.js"]`);
			getExists(`script[defer][type="module"][src="/assets/ophan.js"]`);
