...
export const SignInGateStory = () => {
    ...
    return (
        <>
            ...
            >
                Implement the sign-in-gate layout, maybe we can do this by
                forcing an ABTest cookie and having a <i>default</i> sign-in
                gate.
                <br />
                <br />
                However, it might be better that we test the{' '}
                <b>functionality</b> with a Cypress test, rather than a full
                layout like this.
                <br />
                <br />
                Generally, adding a story for each component / style of the
                component (self contained) is enough for visual regression and
                then you can use Cypress to test that the gate you expect etc is
                loaded.
                <br />
                <br />
                There is an example in article.e2e.spec.js of testing an AB
                test, so it is likely that that is the route you want to go with
                here rather than a storybook story.
            </p>
            <HydratedLayout ServerCAPI={ServerCAPI} />
        </>
    );
};
SignInGateStory.story = {
    name: 'WithSignInGate',
};
