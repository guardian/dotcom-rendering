...
export const ArticleStory = () => {
    const CAPI = convertToImmersive(Article);
    mockRESTCalls();
    setTimeout(() => hydrateIslands(CAPI, NAV));
...
export const ReviewStory = () => {
    const CAPI = convertToImmersive(Review);
    mockRESTCalls();
    setTimeout(() => hydrateIslands(CAPI, NAV));
    return <DecideLayout designType={CAPI.designType} CAPI={CAPI} NAV={NAV} />;
};
...
export const CommentStory = () => {
    const CAPI = convertToImmersive(Comment);
    mockRESTCalls();
    setTimeout(() => hydrateIslands(CAPI, NAV));
    return <DecideLayout designType={CAPI.designType} CAPI={CAPI} NAV={NAV} />;
};
...
export const AdvertisementFeatureStory = () => {
    const CAPI = convertToImmersive(AdvertisementFeature);
    mockRESTCalls();
    setTimeout(() => hydrateIslands(CAPI, NAV));
    return <DecideLayout designType={CAPI.designType} CAPI={CAPI} NAV={NAV} />;
};
...
export const AnalysisStory = () => {
    const CAPI = convertToImmersive(Analysis);
    mockRESTCalls();
    setTimeout(() => hydrateIslands(CAPI, NAV));
    return <DecideLayout designType={CAPI.designType} CAPI={CAPI} NAV={NAV} />;
};
...
export const FeatureStory = () => {
    const CAPI = convertToImmersive(Feature);
    mockRESTCalls();
    setTimeout(() => hydrateIslands(CAPI, NAV));
    return <DecideLayout designType={CAPI.designType} CAPI={CAPI} NAV={NAV} />;
};
...
export const GuardianViewStory = () => {
    const CAPI = convertToImmersive(GuardianView);
    mockRESTCalls();
    setTimeout(() => hydrateIslands(CAPI, NAV));
    return <DecideLayout designType={CAPI.designType} CAPI={CAPI} NAV={NAV} />;
};
...
export const ImmersiveStory = () => {
    const CAPI = convertToImmersive(Immersive);
    mockRESTCalls();
    setTimeout(() => hydrateIslands(CAPI, NAV));
    return <DecideLayout designType={CAPI.designType} CAPI={CAPI} NAV={NAV} />;
};
...
export const InterviewStory = () => {
    const CAPI = convertToImmersive(Interview);
    mockRESTCalls();
    setTimeout(() => hydrateIslands(CAPI, NAV));
    return <DecideLayout designType={CAPI.designType} CAPI={CAPI} NAV={NAV} />;
};
...
export const QuizStory = () => {
    const CAPI = convertToImmersive(Quiz);
    mockRESTCalls();
    setTimeout(() => hydrateIslands(CAPI, NAV));
    return <DecideLayout designType={CAPI.designType} CAPI={CAPI} NAV={NAV} />;
};
...
export const RecipeStory = () => {
    const CAPI = convertToImmersive(Recipe);
    mockRESTCalls();
    setTimeout(() => hydrateIslands(CAPI, NAV));
    return <DecideLayout designType={CAPI.designType} CAPI={CAPI} NAV={NAV} />;
};
...
export const MatchReportStory = () => {
    const CAPI = convertToImmersive(MatchReport);
    mockRESTCalls();
    setTimeout(() => hydrateIslands(CAPI, NAV));
    return <DecideLayout designType={CAPI.designType} CAPI={CAPI} NAV={NAV} />;
};
