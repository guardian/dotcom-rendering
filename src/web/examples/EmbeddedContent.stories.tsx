...
function body(pillar:CAPIPillar, design:Design, display:Display) {
    return [
        <p>Example of an instagram embed, the source article is <a href="https://www.theguardian.com/culture/2019/apr/27/idris-elba-marries-sabrina-dhowre-in-morocco">here</a></p>,
        <Figure role="inline">
        ...
        <p>Example of a formstack embed, the source article is <a href="https://www.theguardian.com/books/2019/nov/23/utopian-novels-for-dystopian-times">here</a></p>,
        <Figure role="inline">
            <UnsafeEmbedBlockComponent
                key='1'
        ...
        <p>Example of a spotify embed, the source article is <a href="https://www.theguardian.com/music/2020/may/07/beethoven-brahms-mozart-review">here</a></p>,
        <Figure role="inline">
        ...
        <p>Example of a facebook post embed, the source article is <a href="https://www.theguardian.com/uk-news/2019/aug/16/police-officers-death-sparks-sweeping-inquiry">here</a></p>,
        <Figure role="inline">
            <EmbedBlockComponent
                key={1}
        ...
        <p>Example of a vimeo embed from 'embed' element type, the source article is <a href="https://www.theguardian.com/film/2020/oct/12/ultraviolence-ken-fero-documentary-injustice-deaths-police">here</a></p>,
        <Figure role="inline">
            <EmbedBlockComponent
                key={1}
        ...
        <p>Example of a vimeo embed from 'video' element type, the embed source article is <a href="https://www.theguardian.com/culture/2020/oct/29/alice-fraser-the-10-funniest-things-i-have-ever-seen-on-the-internet">here</a></p>,
        <Figure role="inline">
            <VimeoBlockComponent
                pillar={pillar}
        ...
        <p>Example of a scribd embed from a 'document' element type, the embed source article is <a href="https://www.theguardian.com/politics/2020/jul/21/what-does-the-russia-report-mean-for-british-people-and-politics">here</a></p>,
        <Figure role="inline">
...
const EmbeddedElements = {
    ...
    spotifyEmbed:{
        ...
        "title": "Brahms: 6 Piano Pieces, Op. 118: II. Intermezzo. Andante teneramente (Live at Church of San Bernardo, Rabbi / 2019)",
        "height": 380,
        "caption": undefined
    },
    facebookEmbed:{
