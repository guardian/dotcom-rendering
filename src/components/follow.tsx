...
const FollowIcon: FC<IconProps> = ({ format }) => {
	const iconStyles = ({ theme }: Format): SerializedStyles => {
		...
		return css`
			...
			.js-status-follow &.js-following-icon {
				display: none;
			}
			.js-status-following &.js-follow-icon {
				display: none;
			}
		`;
	};
	...
	return (
		<>
			<svg
				...
				css={iconStyles(format)}
				className="js-following-icon"
			>
				<path
					fillRule="evenodd"
					clipRule="evenodd"
