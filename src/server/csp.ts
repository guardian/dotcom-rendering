...
const buildCsp = ({ styles, scripts }: Assets, twitter: boolean): string => `
    ...
    connect-src 'self' https://interactive.guim.co.uk https://sf-hs-sg.ibytedtos.com/ https://discussion.theguardian.com/discussion-api/ https://gdn-cdn.s3.amazonaws.com/
`.trim();
