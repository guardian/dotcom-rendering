...
const rootPath = `https://editions-preview.code.dev-guardianapis.com/`;
...
export const previewPageFonts = `
    ${fontFace(
		...
		some(400),
		none,
		`${rootPath}assets/fonts/GuardianTextEgyptian-Reg.ttf`,
	)}
    ${fontFace(
		'Guardian Text Egyptian Web',
		some(400),
		some('italic'),
		`${rootPath}assets/fonts/GuardianTextEgyptian-RegItalic.ttf`,
	)}
    ${fontFace(
		'Guardian Text Egyptian Web',
		some(700),
		none,
		`${rootPath}assets/fonts/GuardianTextEgyptian-Bold.ttf`,
	)}
    ${fontFace(
		'Guardian Text Egyptian Web',
		some(700),
		some('italic'),
		`${rootPath}assets/fonts/GuardianTextEgyptian-BoldItalic.ttf`,
	)}
    ${fontFace(
		'Guardian Text Egyptian Web',
		some('bold'),
    ...
    ${fontFace(
		...
		some(400),
		none,
		`${rootPath}assets/fonts/GuardianTextSans-Regular.ttf`,
	)}
    ${fontFace(
		'Guardian Text Sans Web',
		some(400),
		some('italic'),
		`${rootPath}assets/fonts/GuardianTextSans-RegularItalic.ttf`,
	)}
    ${fontFace(
		'Guardian Text Sans Web',
		some(700),
		none,
		`${rootPath}assets/fonts/GuardianTextSans-Bold.ttf`,
	)}
    ${fontFace(
		'Guardian Text Sans Web',
		some(700),
		some('italic'),
		`${rootPath}assets/fonts/GuardianTextSans-BoldItalic.ttf`,
	)}
    ...
    ${fontFace(
		...
		some(300),
		none,
		`${rootPath}assets/fonts/GHGuardianHeadline-Light.ttf`,
	)}
    ${fontFace(
		'GH Guardian Headline',
		some(300),
		some('italic'),
		`${rootPath}assets/fonts/GHGuardianHeadline-LightItalic.ttf`,
	)}
    ${fontFace(
		'GH Guardian Headline',
		some(400),
		none,
		`${rootPath}assets/fonts/GHGuardianHeadline-Regular.ttf`,
	)}
    ${fontFace(
		'GH Guardian Headline',
		some(400),
		some('italic'),
		`${rootPath}assets/fonts/GHGuardianHeadline-RegularItalic.ttf`,
	)}
    ${fontFace(
		'GH Guardian Headline',
		some(500),
		none,
		`${rootPath}assets/fonts/GHGuardianHeadline-Medium.ttf`,
	)}
    ${fontFace(
		'GH Guardian Headline',
		some(500),
		some('italic'),
		`${rootPath}assets/fonts/GHGuardianHeadline-MediumItalic.ttf`,
	)}
    ${fontFace(
		'GH Guardian Headline',
		some(600),
		none,
		`${rootPath}assets/fonts/GHGuardianHeadline-Semibold.ttf`,
	)}
    ${fontFace(
		'GH Guardian Headline',
		some(600),
		some('italic'),
		`${rootPath}assets/fonts/GHGuardianHeadline-SemiboldItalic.ttf`,
	)}
    ${fontFace(
		'GH Guardian Headline',
		some(700),
		none,
		`${rootPath}assets/fonts/GHGuardianHeadline-Bold.ttf`,
	)}
    ${fontFace(
		'GH Guardian Headline',
		some(700),
		some('italic'),
		`${rootPath}assets/fonts/GHGuardianHeadline-BoldItalic.ttf`,
	)}
