...
const acquisitionsClient: Acquisitions.Client<void> = createAppClient<Acquisitions.Client<void>>(Acquisitions.Client, 'buffered', 'compact');
const notificationsClient: Notifications.Client<void> = createAppClient<Notifications.Client<void>>(Notifications.Client, 'buffered', 'compact');
const userClient: User.Client<void> = createAppClient<User.Client<void>>(User.Client, 'buffered', 'compact');
